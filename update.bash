...
git_clone_or_pull envyfile-postfixrelay 4P git@github.com:4P/envyfile-postfixrelay.git
...
git_clone_or_pull cloud-backup 4P git@github.com:4P/cloud-backup.git
git_clone_or_pull changeling bcwaldon git@github.com:bcwaldon/changeling.git
...
git_clone_or_pull fb303 4P git@github.com:4P/fb303.git
...
git_clone_or_pull releasenotes 4P git@github.com:4P/releasenotes.git
git_clone_or_pull zendesk origin git@github.com:eventbrite/zendesk.git
add_remote zendesk heckj git@github.com:heckj/zendesk.git
...
git_clone_or_pull engdash 4P git@github.com:4P/engdash.git
